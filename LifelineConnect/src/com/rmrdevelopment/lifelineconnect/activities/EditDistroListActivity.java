...
public class EditDistroListActivity extends BaseActivityClass {
	...
	private void clickEvents() {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(EditDistroListActivity.this,
	...
	protected void SearchUsers(final String searchString) {
		// TODO Auto-generated method stub
		progressDialog = ProgressDialog.show(EditDistroListActivity.this, null,
				"Loading...	", true, false);
		Thread t = new Thread(new Runnable() {
