...
public class SendMessageActivity extends BaseActivityClass {
	...
	private ArrayList<String> listAdapter = new ArrayList<String>();
	...
	private RelativeLayout layoutDistro;
	private RelativeLayout layoutIndividual;
	private RelativeLayout layoutUpline;
	...
	private void clickEvents() {
		...
		btnSearch.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				final String sreachedString = editName.getText().toString()	.trim();
			...
			public void onClick(View arg0) {
				...
				for (int i = 0; i < LLCApplication.getDistroLists().size(); i++) {
					if (LLCApplication.getDistroLists().get(i).get("checked")
						...
						if (strtags.length() == 0) {
							strtags += LLCApplication.getDistroLists().get(i).get("Description");
							strIDs += LLCApplication.getDistroLists().get(i).get("ID");
						} else {
							strtags += ", "+ LLCApplication.getDistroLists().get(i).get("Description");
							strIDs += ";"+ LLCApplication.getDistroLists().get(i).get("ID");
						}
	...
	public void replyWithVoice(final String message,
		...
		progressDialog = ProgressDialog.show(SendMessageActivity.this, null,
				"Loading...	", true, false);
	...
	private MediaRecorder.OnErrorListener errorListener = new MediaRecorder.OnErrorListener() {
		...
		public void onError(MediaRecorder mr, int what, int extra) {
			Toast.makeText(SendMessageActivity.this, "Error: " + what + ", " + extra,
					Toast.LENGTH_SHORT).show();
		}
	};
	...
	private MediaRecorder.OnInfoListener infoListener = new MediaRecorder.OnInfoListener() {
		...
		public void onInfo(MediaRecorder mr, int what, int extra) {
			Toast.makeText(SendMessageActivity.this, "Warning: " + what + ", " + extra,
					Toast.LENGTH_SHORT).show();
		}
	};
