...
public class BaseMDActivity extends SlidingFragmentActivity {

	private int mTitleRes;
	protected Fragment mFrag;
	
	
	public BaseMDActivity(int titleRes) {
		mTitleRes = titleRes;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		BaseActivityClass.baseAct = this;
	}
